...
def read_tiff_image(img_path: Path) -> np.ndarray | None:
    """读取TIF图片.
...
def visualize_labels(
    ...
    try:
        ...
        for i, label in enumerate(labels):
            ...
            # 标签文字
            draw.text((x1 + 5, y1 - text_height - 3), label_text, fill=(255, 255, 255))
...
def main():
    ...
    parser.add_argument("--img-name", type=str, default="moxizheng_0.2m_UAV0069", help="指定图片名称")
